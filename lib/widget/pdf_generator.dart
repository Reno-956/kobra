...
Future<dynamic> pdfGenerator(
              ...
              Row(
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          child: Text(store.razonSocial,
                              style: const TextStyle(color: PdfColors.blue)),
                        ),
                        Container(child: Text(store.direccion)),
                        Container(
                            child: Text(
                  ...
                  children: <Widget>[
                    Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(child: Text(user.nombre)),
                          ...
                          Container(child: Text(user.perfil ?? '-')),
                        ]),
                  ]),
              SizedBox(height: 10),
              Align(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 40),
                          Container(
                            child: Text(salary.management ?? store.razonSocial),
                          ),
                        ])
                  ]),
              Row(children: [
  ...
  if (Platform.isWindows) {
    ...
    await FileSaver.instance.saveAs(
        name:
            'salary-kasir-${user.nombre.trim()}-${DateTime.now().millisecondsSinceEpoch}',
        file: file,
        ext: 'pdf',
