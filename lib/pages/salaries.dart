                  ...
                  return SingleChildScrollView(
                    child: Column(
                      children: salary.map((item) {
                        ...
                        return ListTile(
                          title: FutureBuilder<UsuarioModel?>(
                            future: Database().obtenerUserPorId(item.userId),
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                return Text(
                                    '${snapshot.data?.nombre ?? 'Admin'} (${currency.format(item.total)})');
                              }
