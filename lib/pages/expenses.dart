                ...
                if (PlatformExtension.isMobile) {
                  return Column(
                    children: data
                        .map((v) => ListTile(
                              title: Text(v.titulo),
                              subtitle: Text(currency.format(v.cantidad)),
                              trailing:
                                  Text(dateWithoutTime.format(v.hechoEn!)),
                            ))
                        .toList(),
                  );
                }
                    ...
                    DataTable(
                        ...
                        rows: data
                            .map((val) => DataRow(cells: [
                                  ...
                                  DataCell(Text(val.titulo)),
                                  DataCell(Text(currency.format(val.cantidad))),
                                  DataCell(Text(val.nota ?? '')),
                                  DataCell(Text(dateWithTime
                                      .format(val.hechoEn ?? DateTime.now()))),
                                  DataCell(
